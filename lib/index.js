...
var main = function (imageName) { return __awaiter(void 0, void 0, void 0, function () {
    var image;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                image = new BMPBuffer_1.default(imageName);
                return [4 /*yield*/, image.init()];
            case 1:
                _a.sent();
                return [4 /*yield*/, image.createNegativeBMP()];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
