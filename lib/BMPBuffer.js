...
var BMPBuffer = /** @class */ (function () {
    ...
    BMPBuffer.prototype.copyBMPHeader = function (ogBuffer, bufferTemp) {
        for (var i = 0; i < 54; i++) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.writeImage(this.bufferTemp, this.fileName)];
                    case 2:
                        _a.sent();
                    ...
                    case 3:
                        err_2 = _a.sent();
                        console.error('❌ The Creation of the Image had an error!', String(err_2));
    ...
    BMPBuffer.prototype.writeImage = function (buffer, fileName) {
        if (fileName === void 0) { fileName = 'tempPic'; }
    ...
    BMPBuffer.prototype.mutatebufferTempColors = function () {
        var start = this.offset;
        // traverse and inverse colors
        try {
            for (var i = start; i < this.bufferTemp.length; i += 3) {
                var r = this.buffer.readUInt8(i);
                var g = this.buffer.readUInt8(i + 1);
                var b = this.buffer.readUInt8(i + 2);
    ...
    BMPBuffer.prototype.analyzeBMP = function (buffer) {
        ...
        if (bitsPerPixel !== this.bitsPerPixel) {
            console.error('❌ The Bytes Per Pixel Is Incorrect \nThe Image must be in 24 BPP format');
